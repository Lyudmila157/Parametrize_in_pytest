...
passwords = ['nckanknc', 'qwerty123', 'asdfg321']
...
#     'creds',
#     [
#         pytest.param(('user1@mail.com', 'nckanknc'), id='user1@mail.com, nckanknc'),
#         pytest.param(('user2@mail.com', 'qwerty123'), id='user2@mail.com, qwerty123'),
#         pytest.param(('user3@mail.com', 'asdfg321'), id='user3@mail.com, asdfg321')
#     ]
# )
@pytest.mark.skip
